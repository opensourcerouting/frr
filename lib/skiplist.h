...
extern int skiplist_delete(struct skiplist *l, void *key,
			   void *value);

extern int skiplist_search(struct skiplist *l, void *key,
			   void **valuePointer);
...
extern int skiplist_first(struct skiplist *l, void **keyPointer,
			  void **valuePointer);

extern int skiplist_last(struct skiplist *l, void **keyPointer,
			 void **valuePointer);
