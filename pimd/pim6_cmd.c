...
DEFPY_YANG(pim6_embedded_rp_group_list,
           ...
           "embedded-rp group-list WORD$prefix_list",
           PIM_EMBEDDED_RP
           ...
           "Embedded RP permitted groups\n")
{
	...
	nb_cli_enqueue_change(vty, xpath, NB_OP_MODIFY, prefix_list);

	return nb_cli_apply_changes(vty, NULL);
}

DEFPY_YANG(no_pim6_embedded_rp_group_list,
           no_pim6_embedded_rp_group_list_cmd,
           "no embedded-rp group-list [WORD]",
           NO_STR
           PIM_EMBEDDED_RP
           "Configure embedded RP permitted groups\n"
           "Embedded RP permitted groups\n")
...
DEFPY_YANG(pim6_embedded_rp_limit,
           ...
           "embedded-rp limit (1-4294967295)$limit",
           PIM_EMBEDDED_RP
           ...
           "Maximum amount of embedded RPs to learn\n")
{
	...
	nb_cli_enqueue_change(vty, xpath, NB_OP_MODIFY, limit_str);

	return nb_cli_apply_changes(vty, NULL);
}

DEFPY_YANG(no_pim6_embedded_rp_limit,
           no_pim6_embedded_rp_limit_cmd,
           "no embedded-rp limit [(1-4294967295)]",
           NO_STR
           PIM_EMBEDDED_RP
           "Limit the amount of embedded RPs to learn\n"
           "Maximum amount of embedded RPs to learn\n")
...
void pim_cmd_init(void)
{
	...
	install_element(PIM6_NODE, &no_pim6_embedded_rp_group_list_cmd);
	install_element(PIM6_NODE, &pim6_embedded_rp_limit_cmd);
	install_element(PIM6_NODE, &no_pim6_embedded_rp_limit_cmd);
