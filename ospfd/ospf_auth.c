 ...
 *
 * Resolution order:
 *  1. Per-address params (oi->params) — set when the operator specified an
 *     A.B.C.D address with "ip ospf compatible rfc7474 A.B.C.D".
 *  2. Interface default params (IF_DEF_PARAMS) — set when the operator used
 *     "ip ospf compatible rfc7474" without an address.
