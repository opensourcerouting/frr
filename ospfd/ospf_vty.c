       ...
       "Address of interface\n")
{
	...
	/*
	 * Without A.B.C.D: apply to the interface default params, affecting all
	 * addresses on this interface. With A.B.C.D: apply to per-address
	 * params, scoping the override to a single address on multi-address
	 * interfaces.
	 */
	params = IF_DEF_PARAMS(ifp);
